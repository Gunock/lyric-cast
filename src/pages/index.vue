...
<template>
  <header class="absolute inset-x-0 top-0">
    <div class="container flex justify-end p-4 mx-auto">
      <button class="overflow-hidden p-2" @click="switchTheme()">
        <transition
  ...
  <main class="justify-center py-16 px-4 mx-auto max-w-4xl h-screen">
    <h1 class="pb-20 text-6xl text-center text-gray-700 dark:text-gray-100 transition-colors">LyricCast privacy policy</h1>
    <section>
      <p>
        Tomasz Kiljańczyk built the LyricCast app as an Ad Supported app. This SERVICE is provided by Tomasz Kiljańczyk at no cost and is intended for use as
        is.
      </p>
      <p>
      ...
      <p>
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at LyricCast unless otherwise defined
    ...
    <section>
      ...
      <p>
        For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information. The information that
    ...
    <section>
      ...
      <div>
        <p>
          These Services do not address anyone under the age of 13. I do not knowingly collect personally identifiable information from children under 13 years
          of age. In the case I discover that a child under 13 has provided me with personal information, I immediately delete this from our servers. If you are
          a parent or guardian and you are aware that your child has provided us with personal information, please contact me so that I will be able to do the
          necessary actions.
        </p>
      </div>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        <a href="mailto:asz.czyk.dev@gmail.com">asz.czyk.dev@gmail.com.</a>
      </p>
...
h2 {
  @apply pb-5 text-3xl font-bold;
}

h3 {
  @apply pb-5 pt-5 text-xl font-bold;
}
